...
MY_AUTOTUNE_ENABLE = "N"    # Y = Enabled (Elecraft K3) --  Otherwise, radio doesn't matter.
...
# K3_string, switch_pos, tune_secs, KAT500_string
    [b'BN00',   "FIVE",    0,  b'AN3;MDM;', "160M", 160],   #160M   Dummy load for safety
    ...
    [b'BN05',   "TWO",     1,  b'AN2;MDM;',  "20M", 20],    # 20M   Vertical / HexBeam (ANT1/ANT2)
    [b'BN06',   "ONE",     4,  b'AN1;MDM;',  "17M", 17],    # 17M   HexBeam  / HexBeam (ANT1/ANT2)
    [b'BN07',   "TWO",     1,  b'AN2;MDM;',  "15M", 15],    # 15M   HexBeam  / HexBeam (ANT1/ANT2)
    [b'BN08',   "ONE",     4,  b'AN1;MDM;',  "12M", 12],    # 12M   HexBeam  / HexBeam (ANT1/ANT2)
    [b'BN09',   "TWO",     1,  b'AN2;MDM;',  "10M", 10],    # 10M   HexBeam  / HexBeam (ANT1/ANT2)
    [b'BN10',   "THREE",   1,  b'AN2;MDM;',  "6M",   6]     #  6M   HexBeam (Dipole avaiable on WR9R-THREE)
]
# other possibilities..
